...
class UnitTestRubyCal < Test::Unit::TestCase
  ...
  #   cal=Calendar.new(2, 2012)
  #   assert_equal("We", cal.first_4_week)
  # end

  # def test_10_passing_in_month_year_returns_position_of_first_day
  #   cal=Calendar.new(2, 2012)
  #   assert_equal("          1", cal.first_4_weeks)
  # end

  # def test_10_first_week_returns_right_number_of_days
  #   cal=Calendar.new(2, 2012)
  #   assert_equal([1, 2, 3, 4], cal.format_first_week)
  # end
